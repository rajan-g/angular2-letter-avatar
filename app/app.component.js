 ...
 * @author RAJAN G
 */
System.register(['angular2/core', '../directives/letter-avatar.directive'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, letter_avatar_directive_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        selector: 'my-app',
                        directives: [letter_avatar_directive_1.LetterAvatarDirective],
